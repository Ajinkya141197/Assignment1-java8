...
class Item{
    ...
    protected Item(int id, String item_name, String category_name, double price, String date_of_manufacturing,
            String date_of_expiring) {
        super();
        this.id = id;
        this.item_name = item_name;
    ...
    public String toString() {
        return "Item [itemid=" + id + ", item_name=" + item_name + ", category_name=" + category_name + ", price="
...
public class Assignment1Q16 {

    public static void main(String[] args) {
        List<Item> items=new ArrayList<>();

        items.add(new Item(1,"milk","travel",3000,"22/10/2024","22/10/2026"));
        items.add(new Item(2,"paneer","computer_accessories",4500,"02/01/2020","26/10/2029"));
        items.add(new Item(3,"egg","study",500,"22/10/2020","11/05/2027"));
        items.add(new Item(4,"fruits","study",300,"15/04/2024","16/09/2029"));
        items.add(new Item(5,"bekari","furniture",6000,"23/10/2021","23/10/2026"));    
